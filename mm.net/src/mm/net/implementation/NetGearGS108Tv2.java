  ...
  public Response getStaticName(int vlanId) {
    try {
      ...
      if (event != null) {
        ...
        return errorHandler("getStaticName", "SNMP-GET timed out or IOException");
      }
  ...
  public Response getEgressPorts(int vlanId) {
    try {
      ...
      if (event != null) {
        ...
        return errorHandler("getEgressPorts", "SNMP-GET timed out or IOException");
      }
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public Response getUntaggedPorts(int vlanId) {
    try {
      ...
      if (event != null) {
        ...
        return errorHandler("getUntaggedPorts", "SNMP-GET timed out or IOException");
      }
    } catch (Exception e) {
      e.printStackTrace();
